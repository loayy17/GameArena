const fr = {
  ...
  settings: {
    profile: {
      ...
      avatar: "Avatar",
      avatarUpload: "Importer un avatar",
      avatarUploading: "Importation…",
      avatarRemove: "Supprimer l'avatar",
      avatarSaved: "Avatar mis à jour avec succès",
      avatarSaveFailed: "Échec de l'importation de l'avatar",
      avatarRemoved: "Avatar supprimé",
      avatarRemoveFailed: "Échec de la suppression de l'avatar",
      avatarTooLarge: "L'image doit faire 2 Mo ou moins",
      avatarInvalidType: "Seuls les formats PNG, JPEG, WebP ou GIF sont autorisés",
      invalidUsername: "Le nom d'utilisateur doit contenir 3 à 20 caractères (lettres, chiffres ou underscores)",
    },
    password: {
