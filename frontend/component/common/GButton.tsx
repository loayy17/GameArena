...
const variants: Record<string, string> = {
  ...
  outline: "border border-border bg-transparent text-text hover:bg-primary-muted",
    ...
    return (
      <button
        ...
        className={clsx(
          ...
          variant !== "link" && isIconOnly && "h-10 w-10 p-0",
          variant !== "link" && roundedStyles[roundedProp],
